...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Plant disease detection</strong> ", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen",u"<strong>Created by</strong>: Vigneswaran Bala, Motheswar Mani, Nishaanth Kadir, Nikil Kumar", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Mechanical Engineering Sri Sairam Engineering College(2017-2021)</strong>", None))
    # retranslateUi
